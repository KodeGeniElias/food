...
//$index_file = $_SERVER["HTTP_HOST"].'/Food/index';

/*if (!isset($_SERVER['DOCUMENT_ROOT']) || empty($_SERVER['DOCUMENT_ROOT'])){
    $_SERVER['DOCUMENT_ROOT'] = _DIR__; //or dirname(__FILE_) for older php versions
}
*/
//$index_file = __DIR__.'/Food/index';

//$index_file = define ('DOCUMENT_ROOT', dirname(__FILE__).'/Food/index');

//***********PATH FILES*****************//
//**************************************//
//$index_file = $_SERVER["DOCUMENT_ROOT"].'/d828113e/Food/index1';
$index_file = $_SERVER["DOCUMENT_ROOT"].'/Food/index1';
//echo $index_file;
//$index_file = 'htionline.tue.nl/d828113e/Food/index';
...
if (!file_exists($index_file)) {
    ...
    //$file = fopen($_SERVER["HTTP_HOST"].'/Food/visual_data.csv', 'r');
    $file = fopen($_SERVER['DOCUMENT_ROOT'].'/Food/visual_data.csv', 'r');
    //$file = fopen($_SERVER['DOCUMENT_ROOT'].'/d828113e/Food/visual_data.csv', 'r');

    /*if (!isset($_SERVER['DOCUMENT_ROOT']) || empty($_SERVER['DOCUMENT_ROOT'])){
    $_SERVER['DOCUMENT_ROOT'] = _DIR__; //or dirname(__FILE_) for older php verstions
    }
    $file = fopen(__DIR__.'/Food/visual_data.csv');
    */
    //$file = define ('DOCUMENT_ROOT', dirname(__FILE__).'/Food/visual_data.csv');
