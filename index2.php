...
<FORM id="mlwebform" name="mlwebform" onSubmit="return false" method="POST" action="save.php">
            ...
            <input id="expName" type=hidden name="expname" value="index2">
            <input type=hidden name="nextURL" value="SurveyC2.php">
...
<div style="width: 100%; max-width: 500px; margin: 0 auto;">
   ...
   <p class="text-center">Task 2/4</p>
        ...
        <p> Please use the search bar below to type in the following search term: <b><?php echo($_SESSION['c2qt']);?></b>. It is important that you use <b>exactly</b> this search term.</p>
