...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
            ...
            <input id="expName" type=hidden name="expname" value="survey4">
            <input type=hidden name="nextURL" value="thanks.html">
			<!-- save query info for first shown query-->
			<input type=hidden name="queryterm" value="<?php echo($_SESSION['c4qt']);?>"> 
            <input type=hidden name="querytype" value="<?php echo($_SESSION['c4q']);?>">
     ...
     <header class="w3-container w3-blue w3-center">
       ...
       <div class="w3-white w3-container">
            <h2>Questions about your search for <b><?php echo($_SESSION['c4qt']);?></b> </h2>
            <p> Below, we have formulated a number of propositions about the list of recipes for your search query <b><?php echo($_SESSION['c4qt']);?></b> and your chosen recipe. Please indicate to what extent you (dis)agree with each of them. 
